      ...
      <section className="bg-surface py-16 sm:py-20">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-semibold text-ink font-serif">Small, senior-led teams.</h2>
            <p className="mt-4 text-base text-ink-muted">
              We run lean teams with senior oversight at every stage. That means faster decisions, cleaner execution, and fewer surprises for your stakeholders.
            </p>
          </div>
          <div className="rounded-3xl border border-border bg-surface-3 p-6 text-sm text-ink-muted">
            <p className="text-ink">Our leadership team has managed large-scale conferences, government summits, and VIP hospitality programs across the UAE.</p>
            <p className="mt-4">We value precise planning, consistent crew communication, and an onsite presence that keeps the room calm.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface-3 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            {values.map((value) => (
              <div key={value.title} className="rounded-3xl border border-border bg-surface-2 p-6">

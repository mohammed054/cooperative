...
export function Navbar() {
  ...
  /* Over hero: transparent with white text.
     After scroll: white frosted glass with dark text. */
  ...
  return (
    <motion.header
      ...
      style={{
        ...
        transition:
          'background 0.55s ease, border-color 0.55s ease, backdrop-filter 0.55s ease',
      }}
    >
      <nav className="flex items-center justify-between px-8 md:px-14 py-5">
        ...
        <a
          ...
          style={{
            ...
            fontFamily: 'var(--font-body)',
            fontWeight: 400,
            color: overHero ? 'var(--color-accent-1)' : 'var(--color-accent-1)',
          ...
          onMouseLeave={(e) => {
            ...
            (e.currentTarget as HTMLAnchorElement).style.borderColor =
              `rgba(197,160,89,${overHero ? '0.55' : '0.45'})`;
          }}
        >
          Enquire
        </a>

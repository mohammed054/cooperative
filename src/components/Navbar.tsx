/**
 * Navbar — Full Rework ($25k tier)
 * ─────────────────────────────────────────────────────────────
 * Features:
 *   ✓ Official logo (/logo.webp) + GHAIM wordmark
 *   ✓ SERVICES | WORK | PROCESS | COMPANY | PRICING navigation
 *   ✓ Elegant mega-menu dropdowns on hover
 *   ✓ Full-screen mobile overlay with staggered links
 *   ✓ Transparent → frosted glass on scroll
 *   ✓ Auto-hide on scroll down, reveal on scroll up
 *   ✓ Gold underline micro-interaction per link
 */
...
function MegaDropdown({
  ...
  item: (typeof NAV_ITEMS)[number] & { hasDropdown: true };
  overHero: boolean;
}) {
  const { dropdown } = item;
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '4px' }}>
        {'links' in dropdown && dropdown.links.map((link) => (
          <a
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(197,160,89,0.05)'; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = 'transparent'; }}
          >
            <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', fontWeight: 500, color: 'var(--color-text)', letterSpacing: '0.01em' }}>
              {link.label}
            </span>
            <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.68rem', fontWeight: 300, color: 'var(--color-text-muted)' }}>
              {link.sub}
            </span>
          </a>
        ))}
      ...
      <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(197,160,89,0.1)', display: 'flex', justifyContent: 'flex-end' }}>
        <a
          ...
          style={{
            ...
            textTransform: 'uppercase', color: 'var(--color-accent-1)', fontWeight: 500,
          }}
        >
          Enquire Now
          ...
          >
            ...
            <a
              ...
              style={{
                ...
                fontFamily: 'var(--font-body)', fontSize: '0.68rem', letterSpacing: '0.22em',
                textTransform: 'uppercase', color: 'var(--color-accent-1)', fontWeight: 500,
                marginTop: '8px',
              }}
            >
...
export function Navbar() {
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      if (y > heroThreshold) {
        if (dir === 'down' && y - lastScrollY.current > 6) setHidden(true);
          ...
          >
            <img
              ...
              style={{
                ...
                width: 'auto',
                objectFit: 'contain',
                // Ensure the logo is visible against both dark and light backgrounds
            ...
            <span
              style={{
                ...
                color:         overHero ? 'rgba(255,255,255,0.92)' : 'var(--color-text)',
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    fontWeight:    500,
                    color:         overHero
                                     ? (activeDropdown === item.label ? 'rgba(255,255,255,1)' : 'rgba(255,255,255,0.68)')
                                     : (activeDropdown === item.label ? 'var(--color-text)' : 'var(--color-text-mid)'),
                ...
                <AnimatePresence>
                  {item.hasDropdown && activeDropdown === item.label && (
                    <div onMouseEnter={stayOpen} onMouseLeave={closeDropdown}>
                      <MegaDropdown item={item as any} overHero={overHero} />
                    </div>
                  )}
                </AnimatePresence>
              </li>
          ...
          <div className="hidden lg:flex items-center gap-5" style={{ flexShrink: 0 }}>
            ...
            <div
              style={{
                width:       '1px',
                height:      '20px',
                background:  overHero ? 'rgba(255,255,255,0.2)' : 'rgba(197,160,89,0.2)',
            ...
            <a
              ...
              style={{
                ...
                gap:           '8px',
                padding:       '9px 20px',
                border:        `1px solid ${overHero ? 'rgba(197,160,89,0.55)' : 'rgba(197,160,89,0.45)'}`,
                fontFamily:    'var(--font-body)',
                fontSize:      '0.62rem',
                letterSpacing: '0.2em',
                textTransform: 'uppercase',
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLAnchorElement).style.borderColor   = 'rgba(197,160,89,0.8)';
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.background    = 'transparent';
                (e.currentTarget as HTMLAnchorElement).style.borderColor   = overHero ? 'rgba(197,160,89,0.55)' : 'rgba(197,160,89,0.45)';
              }}
            >
              Contact
            ...
            {[0, 1, 2].map((i) => (
              <span
                ...
                style={{
                  ...
                  width:      i === 1 ? '18px' : '24px',
                  height:     '1px',
                  background: overHero ? 'rgba(255,255,255,0.8)' : 'var(--color-text-mid)',

  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          <p className="text-ghaimuae-light-gray text-base lg:text-lg mb-6 lg:mb-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-8">
            <motion.a
              ...
              className="flex items-center justify-center text-ghaimuae-white hover:text-ghaimuae-light-gray transition-colors duration-200"
              whileHover={{ scale: 1.05 }}
            >

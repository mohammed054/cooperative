    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <motion.div className="text-center mb-10 lg:mb-16">
          ...
          >
            Share your timeline, venue, and priorities. We will respond with a clear plan and the right team within 24 hours.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label htmlFor="service" className="block text-ink font-medium mb-2">
                Service Interest *
              </label>
              <select
                id="service"

...
const SolutionsStack = () => {
  ...
  const services = [
    {
      ...
      icon: "🏢",
      color: "from-ghaimuae-primary to-ghaimuae-dark-gray"
    },
    {
      ...
      icon: "🚚",
      color: "from-ghaimuae-primary/90 to-ghaimuae-dark-gray/90"
    },
    {
      ...
      icon: "⚙️",
      color: "from-ghaimuae-primary/80 to-ghaimuae-dark-gray/80"
    },
    {
      ...
      icon: "🎯",
      color: "from-ghaimuae-primary/70 to-ghaimuae-dark-gray/70"
    }
  ];
  ...
  return (
    <section 
      id="services" 
      ref={sectionRef}
      className="min-h-screen flex items-center justify-center bg-ghaimuae-light-gray py-20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-ghaimuae-dark-gray max-w-3xl mx-auto">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="bg-gradient-to-br ${currentServiceData.color} rounded-3xl p-8 lg:p-16 text-ghaimuae-white shadow-2xl"
          >
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl text-ghaimuae-light-gray">
                      {currentServiceData.subtitle}
                    </p>
                  </div>
                </div>

                <p className="text-lg lg:text-xl text-ghaimuae-light-gray mb-8 leading-relaxed">
                ...
                <ul className="space-y-4">
                  {currentServiceData.features.map((feature, index) => (
                    ...
                    >
                      <div className="w-3 h-3 bg-ghaimuae-white rounded-full mr-4"></div>
              ...
              >
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    className="w-64 h-64 lg:w-80 lg:h-80 bg-ghaimuae-white/10 rounded-3xl flex items-center justify-center backdrop-blur-sm border border-ghaimuae-white/20"
                  >
                    <motion.div
                      animate={{ 
                        rotate: [0, -10, 10, 0]
                      ...
                      className="w-48 h-48 lg:w-56 lg:h-56 bg-ghaimuae-white/20 rounded-2xl flex items-center justify-center"
                    >
                      <motion.div
            ...
            <motion.button
              ...
              className={`h-3 rounded-full transition-all duration-300 ${
                index === currentService 
                  ? 'w-12 bg-ghaimuae-primary' 
                  : 'w-3 bg-ghaimuae-primary/30 hover:bg-ghaimuae-primary/50'
              }`}
          ...
          {services.map((service, index) => (
            <motion.button
              ...
              className={`text-sm font-medium transition-all duration-300 ${
                index === currentService 
                  ? 'text-ghaimuae-primary font-semibold' 
                  : 'text-ghaimuae-dark-gray/60 hover:text-ghaimuae-dark-gray'
              }`}
        ...
        {/* Scroll Instruction */}
        <motion.p 
          className="text-center text-ghaimuae-dark-gray/70 mt-8"
          initial={{ opacity: 0 }}
